...
Click on that option and once the file finish downloading make sure to un-zip the file or an easier way is to cut (ctrl x) the file inside the zip file and paste it outside the zip file. Make sure the folder name of the file in inside the zip file be Team-14. 
