...
public class Slots : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        symbolMultipliers[symbols[0]] = 2;  // First Symbol (e.g., Cherry)
        symbolMultipliers[symbols[1]] = 4;  // Second Symbol (e.g., Lemon)
        symbolMultipliers[symbols[2]] = 8;  // Third Symbol (e.g., Watermelon)
    }
    ...
    public void StartSpinning()
    {
        ...
        else if (economy.money < betAmount)
        {
