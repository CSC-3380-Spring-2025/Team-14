...
public class GameManager : MonoBehaviour
{
    ...
    private int startingMoney = 999999; // Default starting money for the player
    private int startingLives = 3; // Default starting lives for the player
    ...
    public void ResetGame()
    {
        ...
        PlayerStats.Lives = startingLives;
        PlayerStats.Rounds = 0;

        // 5. Clean up PlaceTurret singleton
        if (PlaceTurret.instance != null)
        {
        ...
        // Reset wave spawner
        if(waveTimer != null) waveTimer.ResetWaves();
        
        spawner.ResetSpawner(); // Reset wave count
        ...
        if(waveTimer != null && waveTimer.continueButton != null) {
            waveTimer.continueButton.gameObject.SetActive(true);
            waveTimer.continueButton.interactable = true; // Add this for completeness
        }
    ...
    void EndGame()
    {
        ...
        foreach(GameObject enemy in GameObject.FindGameObjectsWithTag("Enemy")) 
        {
            ...
            Destroy(enemy); // Or just destroy them
        }
    ...
    private void UpdateUI()
    {
        ...
        if (livesText != null) livesText.text = "Lives: " + PlayerStats.Lives.ToString();
        else Debug.LogError("LivesText UI element not found.");

        // if (roundsText != null) roundsText.text = "Rounds: " + PlayerStats.Rounds.ToString();
        // else Debug.LogError("RoundsText UI element not found.");
    }
}
